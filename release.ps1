...
$appName = "pruebaAuto" # 👈 Replace with your application project name.
$projDir = "https://coconeitor123.github.io/coconeitor123/pruebaAuto.application/" # 👈 Replace with your project directory (where .csproj resides).
